...
public class TrendingHashtags {
    ...
    public static List<Map.Entry<String, Integer>> findTopTrendingHashtags(List<Tweet> tweets) {
        ...
        // Step 2: extracting the hashtags and count their occurrences
        ...
        // Step 3: sorting hashtags by count (descending) and then by hashtag (descending)
        ...
        // Step 4: selecting the top 3 hashtags
